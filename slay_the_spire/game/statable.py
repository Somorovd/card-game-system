# from .event_manager import Subject
...
#             if event_data["stat"] != self.stat_type:
#                 return
#             self.update_source(source, event_data["amount"])
...
#         stat_update_event_data = {"stat": self.stat_type, "amount": amount}
